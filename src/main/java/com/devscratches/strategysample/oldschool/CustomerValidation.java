...
public final class CustomerValidation implements Predicate<Customer>{
    ...
    public final Predicate<Customer> isOlderThan31 = customer -> customer.getAge() > 31;

    public final Predicate<Customer> hasSpecificEmail = customer -> customer.getEmail() != null && customer.getEmail().endsWith("@email.com");
